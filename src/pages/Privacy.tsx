          ...
          <div className="space-y-6">
            <div>
              <p className="text-black text-base mb-6">
                This Privacy Policy describes how Frostwood Labs, LLC ("we",
                "us", or "our") collects, uses, and protects information when
                you use our mobile applications, software solutions, and digital
                products.
              </p>
            </div>
            <div>
              ...
              <div className="mt-2 space-y-3">
                <div>
                  <h3 className="font-extrabold text-black uppercase">
                  ...
                  <ul className="list-disc pl-6 text-indigo-200 space-y-1">
                    ...
                    <li className="text-black">
                      Payment information for subscriptions and purchases
                    </li>
                    <li className="text-black">
                      User-generated content within our applications
                    </li>
                    <li className="text-black">
            ...
            <div>
              ...
              <ul className="mt-2 list-disc pl-6 text-indigo-200 space-y-1">
                <li className="text-black">
                  Operating and maintaining our mobile applications
                </li>
                <li className="text-black">
                  Personalizing your app experience and content
                </li>
                <li className="text-black">
                  Processing payments for subscriptions and in-app purchases
                </li>
                <li className="text-black">
                  Providing customer support and responding to inquiries
                </li>
                <li className="text-black">
                  Analyzing app usage to improve functionality and performance
                </li>
                <li className="text-black">
                  Sending app updates, security alerts, and administrative
                  messages
                </li>
                <li className="text-black">
            ...
            <div>
              ...
              <p className="mt-2 text-black">We may share your data with:</p>
              <ul className="mt-2 list-disc pl-6 text-indigo-200 space-y-1">
                <li className="text-black">
                  App store platforms (Apple App Store, Google Play Store) for
                  distribution
                </li>
                <li className="text-black">
                  Payment processors for subscription and purchase processing
                </li>
                <li className="text-black">
            ...
            <div>
              ...
              <p className="mt-2 text-black">You have the right to:</p>
              <ul className="mt-2 list-disc pl-6 text-indigo-200 space-y-1">
            ...
            <div>
              ...
              <p className="mt-2 text-black">
                ...
                services and comply with legal obligations. When data is no
            ...
            <div>
              ...
              <p className="mt-2 text-black">
                ...
                outside your home country. We ensure appropriate safeguards are
            ...
            <div>
              ...
              <p className="mt-2 text-black">
                ...
                experience and analyze website usage. You can control cookie
            ...
            <div>
              ...
              <p className="mt-2 text-black">
                For privacy-related inquiries, please contact Frostwood Labs,
                LLC at:
              </p>
