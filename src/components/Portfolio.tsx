...
const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "Mobile app for tracking vehicle locations, maintenance schedules, and driver performance metrics.",
  ...
  },
  {
    ...
    description:
      "Migrated legacy on-premise system to AWS with 99.9% uptime and 40% cost reduction.",
  ...
  },
  {
    ...
    description:
      "Tailored customer relationship management system with automated workflows and reporting.",
  ...
  },
  {
    ...
    description:
      "Real-time business intelligence dashboard with interactive charts and automated reporting.",
  ...
  },
  {
    ...
    description:
      "Industrial IoT solution for monitoring equipment health and predictive maintenance.",
...
const ProjectCard: React.FC<Project> = ({
  ...
  return (
    <div className="brutalist-border brutalist-bg p-8 h-full flex flex-col">
      ...
      <span className="text-sm font-extrabold text-red-600 uppercase mb-2">
        {category}
      </span>
...
const Portfolio: React.FC = () => {
  return (
    <section
      id="portfolio"
      className="section-padding brutalist-bg border-b-8 border-black"
    >
      <div className="container-max px-0">
        ...
        <div className="text-center mt-16">
          <div className="brutalist-border brutalist-bg p-8 max-w-2xl mx-auto">
            <h3 className="text-2xl font-extrabold text-black uppercase mb-4">
              Start Your Project
            </h3>
            <p className="text-lg text-black mb-6">
              Ready to see your vision come to life? Let's discuss your
              requirements.
            </p>
