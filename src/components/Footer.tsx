      ...
      <div className="container-max px-0">
        <div className="py-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <div className="space-y-2">
                <p className="text-black font-bold">
                  <strong>Email:</strong> <a href="mailto:hello@frostwoodlabs.com" className="hover:underline text-black font-extrabold">hello@frostwoodlabs.com</a>
                </p>
                <p className="text-black font-bold">
            ...
            {/* Quick Links */}
            <div>
              <h3 className="text-xl font-extrabold mb-4 uppercase tracking-widest text-black">Quick Links</h3>
              <ul className="space-y-2">
                <li>
                  <Link to="/" className="text-black font-bold uppercase">Home</Link>
                </li>
                <li>
                  <Link to="/terms" className="text-black font-bold uppercase">Terms of Service</Link>
                </li>
                <li>
                  <Link to="/privacy" className="text-black font-bold uppercase">Privacy Policy</Link>
                </li>
              </ul>
            </div>
            {/* Legal */}
